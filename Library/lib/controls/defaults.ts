...
export const defaultSettings: ControlSettingsBySlug = {
  ...
  "form-validation-summary": { showErrors: true, title: "Please correct the following" },
  "phone-number-input": {
    ...baseFieldDefaults,
    label: "Mobile number",
    value: "7700 900123",
  ...
  "lab-sales-pipeline": {},
  "lab-task-workspace": {},
  "lab-notification-centre": {},
  "lab-document-manager": {},
  "lab-product-catalogue": {},
  "lab-quotation-builder": {},
  "lab-sales-order": {},
  "lab-sales-invoice": {},
  "lab-appointment-diary": {},
  "lab-stock-control": {},
  ...
  "lab-register-form": {
    ...
    subtitle: "Create your account with Google, Apple, or email.",
  ...
  "lab-passkey-login-form": {
    ...
    subtitle: "Use your device passkey to sign in securely without a password.",
    title: "Sign in with a passkey",
    verificationCode: "",
  },
  "lab-social-auth-form": {
    email: "",
    name: "",
    password: "",
    confirmPassword: "",
    ...
    remember: false,
    submitLabel: "Sign in",
    subtitle: "Sign in or create an account using your preferred method.",
    title: "Welcome to Opus",
    verificationCode: "",
  },
  "lab-social-register-form": {
    email: "",
    name: "",
    password: "",
    confirmPassword: "",
    ...
    remember: false,
    submitLabel: "Create account",
    subtitle: "Create your account using Google, Apple, or your email address.",
    title: "Join Opus",
    verificationCode: "",
  },
  "lab-forgot-password-form": {
    email: "",
    name: "",
    password: "",
    confirmPassword: "",
  ...
  "lab-check-email-form": {
    ...
    subtitle: "We sent a sign-in link to name@company.com. The link expires in 15 minutes.",
    title: "Check your email",
    verificationCode: "",
  },
  "lab-email-verified-form": {
    email: "",
    name: "",
    password: "",
    confirmPassword: "",
    ...
    subtitle: "Your email address is confirmed. You can now sign in to your workspace.",
    title: "Email verified",
    verificationCode: "",
  },
  "lab-link-expired-form": {
    email: "",
    name: "",
    password: "",
    confirmPassword: "",
    ...
    subtitle: "This verification or reset link is no longer valid. Request a fresh link to continue.",
    title: "Link expired",
    verificationCode: "",
  },
  "lab-change-password-form": {
    email: "",
    name: "",
    password: "",
    confirmPassword: "",
  ...
  "chat-bubble": {
    alignment: "right",
    avatarImage: "/user-profile-carl.png",
    avatarName: "You",
    background: "",
    darkBackground: "",
    betweenMessage: "This editable middle message lets you test adjacent bubble widths.",
    codeMessage: "```ts\nconst answer = 42;\n```",
    content: "Thanks — I’ll test the Show More behaviour with this editable message.\n\nUse the text box in the settings panel to replace this reply, add more lines, or paste a fenced code block.\n\nThe final time remains below the whole group rather than appearing between messages.",
    firstMessage: "Here is a grouped chat message.",
    maxLines: 3,
    lightBackground: "",
    showAvatar: true,
