...
const componentIcons: Record<string, IconDefinition> = {
  ...
  "recurrence-editor": faClockRotateLeft,
  "time-range-picker": faClock,
  "signature-pad": faPenToSquare,
  "diff-viewer": faCodeBranch,
  "save-state-indicator": faCloudArrowUp,
  "async-select": faMagnifyingGlass,
  "editable-data-table": faTableCells,
  "bulk-action-bar": faSquareCheck,
  "file-manager": faInbox,
  "audit-log": faClockRotateLeft,
  "upload-queue": faCloudArrowUp,
  ...
  clock: faClock,
  "flip-clock": faClock,
  "text-marquee": faAlignLeft,
  "background-blobs": faCircle,
  portal: faDoorOpen,
