...
export type ControlTransparency = "none" | "standard" | "glass";
export type ControlGradient = boolean;
...
export type TabsVariant = "line" | "contained" | "card";
export type TabsPanelMode = "active" | "crossfade";
