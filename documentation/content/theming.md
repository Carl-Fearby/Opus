...
- Sets `data-theme="light"` or `data-theme="dark"` on a wrapper element
...
2. If portaling to `document.body`, ensure the portal root has `data-theme` set (see `ContextMenuProvider` for the pattern).
