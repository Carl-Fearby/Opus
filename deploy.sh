...
stage_application_sync_files() {
  local paths=(
    ...
    "Application/app/api/playground-preview/route.ts"
    "Application/app/documentation/playground/external/page.tsx"
    "Application/components/documentation/CodePlayground/ExternalPlaygroundPreview.tsx"
